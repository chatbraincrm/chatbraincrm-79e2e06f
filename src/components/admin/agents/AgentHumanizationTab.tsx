...
function PreviewCard({ cfg }: { cfg: HumanizationConfig }) {
  const [input, setInput] = useState(
    'Boa pergunta! O ChatBrain CRM funciona como uma plataforma white label. Você consegue revender pros seus clientes. Quer que eu te explique como funciona o modelo de receita?'
  );
